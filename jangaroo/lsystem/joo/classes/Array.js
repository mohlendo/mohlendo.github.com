...
"public dynamic class Array",1,function($$private){;return[ 
   ...
   * </listing>
   */
  "public function filter",function filter(callback/*:Function*/, thisObject/*:* = null*/)/*:Array*/ {if(arguments.length<2){thisObject = null;}
   ...
   * </listing></div>
   */
  "public function forEach",function forEach(callback/*:Function*/, thisObject/*:* = null*/)/*:void*/ {if(arguments.length<2){thisObject = null;}
    var i/*:uint*/ = 0,
      j/*:uint*/ = this.length;
    // for maximum performance, repeat for-loop code with different function invocations:
    if (thisObject) {
