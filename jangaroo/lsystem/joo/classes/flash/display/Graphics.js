...
"public final class Graphics",1,function($$private){var as=joo.as;return[function(){joo.classLoader.init(flash.geom.Matrix,flash.display.CapsStyle,Math,flash.display.GradientType,flash.display.JointStyle);}, 
   ...
   *
   */
  "public function beginShaderFill",function beginShaderFill(shader/*:Shader*/, matrix/*:Matrix = null*/)/*:void*/ {if(arguments.length<2){matrix = null;}
   ...
   *
   */
  "public function copyFrom",function copyFrom(sourceGraphics/*:Graphics*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing></div>
   */
  "public function curveTo",function curveTo(controlX/*:Number*/, controlY/*:Number*/, anchorX/*:Number*/, anchorY/*:Number*/)/*:void*/ {var this$=this;
    ...
    this.scheduleCommand$1(function flash$display$Graphics$303_21()/*:void*/ {
      this$.x$1 = anchorX;
      this$.y$1 = anchorY;
   ...
   * </listing>
   */
  "public function drawGraphicsData",function drawGraphicsData(graphicsData/*:Vector$object.<IGraphicsData>*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing></div>
   */
  "public function drawPath",function drawPath(commands/*:Vector$object.<int>*/, data/*:Vector$object.<Number>*/, winding/*:String = "evenOdd"*/)/*:void*/ {if(arguments.length<3){winding = "evenOdd";}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public function drawRoundRectComplex",function drawRoundRectComplex(x/*:Number*/, y/*:Number*/, width/*:Number*/, height/*:Number*/, topLeftRadius/*:Number*/, topRightRadius/*:Number*/, bottomLeftRadius/*:Number*/, bottomRightRadius/*:Number*/)/*:void*/ {
    this.createSpace$1(x, y);
    var x_r/*:Number*/ = x + width;
    var y_b/*:Number*/ = y + height;
    this.createSpace$1(x_r, y_b);
   ...
   *
   */
  "public function drawTriangles",function drawTriangles(vertices/*:Vector$object.<Number>*/, indices/*:Vector$object.<int> = null*/, uvtData/*:Vector$object.<Number> = null*/, culling/*:String = "none"*/)/*:void*/ {if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){indices = null;}uvtData = null;}culling = "none";}
    throw new Error('not implemented'); // TODO: implement!
  },
  ...
  "public function endFill",function endFill()/*:void*/ {
    if (this.fillCommands$1) {
      this.createCanvasSpace$1();
      this.context$1.beginPath();
      for (var i/*:int*/ = 0; i < this.fillCommands$1.length; i++) {
   ...
   *
   */
  "public function lineBitmapStyle",function lineBitmapStyle(bitmap/*:BitmapData*/, matrix/*:Matrix = null*/, repeat/*:Boolean = true*/, smooth/*:Boolean = false*/)/*:void*/ {if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){matrix = null;}repeat = true;}smooth = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function lineShaderStyle",function lineShaderStyle(shader/*:Shader*/, matrix/*:Matrix = null*/)/*:void*/ {if(arguments.length<2){matrix = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function lineTo",function lineTo(x/*:Number*/, y/*:Number*/)/*:void*/ {var this$=this;
    this.createSpace$1(this.x$1, this.y$1);
    this.createSpace$1(x, y);
    this.scheduleCommand$1(function flash$display$Graphics$1010_21()/*:void*/ {
      if (!this$.fillCommands$1) {
        this$.context$1.beginPath();
   ...
   * </listing>
   */
  "public function moveTo",function moveTo(x/*:Number*/, y/*:Number*/)/*:void*/ {var this$=this;
    this.startX$1 = x;
    this.startY$1 = y;
    this.setPosition$1(x, y);
    this.scheduleCommand$1(function flash$display$Graphics$1067_21()/*:void*/ {
      this$.context$1.moveTo(x, y);
    });
  },
  ...
  "private var",{ fillCommands/* : Array*/:null},
  "private var",{ minX/*:Number*/:NaN},
  "private var",{ minY/*:Number*/:NaN},
  "private var",{ maxX/*:Number*/:NaN},
  "private var",{ maxY/*:Number*/:NaN},
  ...
  "private function createSpace",function createSpace(x/*:Number*/, y/*:Number*/)/*:void*/ {
    var thickness/*:Number*/ = this.thickness$1 || 0; // this.thickness may be NaN!
  ...
  "private function createCanvasSpace",function createCanvasSpace()/*:void*/ {
    var imageData/*:ImageData*/;
    var canvas/*:HTMLCanvasElement*/ = this.canvas;
    var intMinX/*:int*/ = Math.floor(this.minX$1);
    var intMinY/*:int*/ = Math.floor(this.minY$1);
    var intWidth/*:int*/ = Math.ceil(this.maxX$1) - intMinX + 1;
    var intHeight/*:int*/ = Math.ceil(this.maxY$1) - intMinY + 1;
  ...
  "private function setPosition",function setPosition(x/*:Number*/, y/*:Number*/)/*:void*/ {
    this.x$1 = x;
    this.y$1 = y;
  },

  "private function restorePosition",function restorePosition()/*:void*/ {
    this.context$1.moveTo(this.x$1, this.y$1);
  },

  "private function scheduleCommand",function scheduleCommand(command/*:Function*/)/*:void*/ {
    if (this.fillCommands$1) {
