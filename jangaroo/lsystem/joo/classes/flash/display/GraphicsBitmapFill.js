...
"public final class GraphicsBitmapFill implements flash.display.IGraphicsFill, flash.display.IGraphicsData",1,function($$private){;return[ 
   ...
   *
   */
  "public function GraphicsBitmapFill",function GraphicsBitmapFill$(bitmapData/*:BitmapData = null*/, matrix/*:Matrix = null*/, repeat/*:Boolean = true*/, smooth/*:Boolean = false*/) {if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){bitmapData = null;}matrix = null;}repeat = true;}smooth = false;}
