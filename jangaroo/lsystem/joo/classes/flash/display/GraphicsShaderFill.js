...
"public final class GraphicsShaderFill implements flash.display.IGraphicsFill, flash.display.IGraphicsData",1,function($$private){;return[ 
   ...
   *
   */
  "public function GraphicsShaderFill",function GraphicsShaderFill$(shader/*:Shader = null*/, matrix/*:Matrix = null*/) {if(arguments.length<2){if(arguments.length<1){shader = null;}matrix = null;}
