...
"public class ShaderJob extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   * @private
   */
  "public function set height",function height$set(value/*:int*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public function get progress",function progress$get()/*:Number*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public function get target",function target$get()/*:Object*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set target",function target$set(value/*:Object*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set width",function width$set(value/*:int*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function ShaderJob",function ShaderJob$(shader/*:Shader = null*/, target/*:Object = null*/, width/*:int = 0*/, height/*:int = 0*/) {flash.events.EventDispatcher.call(this);if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){shader = null;}target = null;}width = 0;}height = 0;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function start",function start(waitForCompletion/*:Boolean = false*/)/*:void*/ {if(arguments.length<1){waitForCompletion = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
