...
"public final class GraphicsStroke implements flash.display.IGraphicsStroke, flash.display.IGraphicsData",1,function($$private){;return[ 
   ...
   *
   */
  "public function get caps",function caps$get()/*:String*/ {
   ...
   * @private
   */
  "public function set caps",function caps$set(value/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public var",{ fill/*:IGraphicsFill*/:null},
   ...
   *
   */
  "public function get joints",function joints$get()/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set joints",function joints$set(value/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public var",{ miterLimit/*:Number*/:NaN},
  /**
   ...
   *
   */
  "public function GraphicsStroke",function GraphicsStroke$(thickness/*:Number = NaN*/, pixelHinting/*:Boolean = false*/, scaleMode/*:String = "normal"*/, caps/*:String = "none"*/, joints/*:String = "round"*/, miterLimit/*:Number = 3.0*/, fill/*:IGraphicsFill = null*/) {if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){thickness = NaN;}pixelHinting = false;}scaleMode = "normal";}caps = "none";}joints = "round";}miterLimit = 3.0;}fill = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
