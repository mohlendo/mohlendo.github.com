...
"public class Shader",1,function($$private){;return[ 
   ...
   */
  "public function set byteCode",function byteCode$set(value/*:ByteArray*/)/*:void*/ {
   ...
   *
   */
  "public function get data",function data$get()/*:ShaderData*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set data",function data$set(value/*:ShaderData*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function get precisionHint",function precisionHint$get()/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set precisionHint",function precisionHint$set(value/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function Shader",function Shader$(code/*:ByteArray = null*/) {if(arguments.length<1){code = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
];},[],["Error"], "0.8.0", "0.9.6"
);