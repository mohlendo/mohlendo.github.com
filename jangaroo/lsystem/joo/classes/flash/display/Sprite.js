...
"public class Sprite extends flash.display.DisplayObjectContainer",5,function($$private){;return[ 
  ...
  "public function get buttonMode",function buttonMode$get()/*:Boolean*/ {
    return this._buttonMode$5; // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function startTouchDrag",function startTouchDrag(touchPointID/*:int*/, lockCenter/*:Boolean = false*/, bounds/*:Rectangle = null*/)/*:void*/ {if(arguments.length<3){if(arguments.length<2){lockCenter = false;}bounds = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function stopTouchDrag",function stopTouchDrag(touchPointID/*:int*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
  ...
  // ************************** Jangaroo part **************************
  "private function updateCursor",function updateCursor()/*:void*/ {
