...
"public class BitmapData implements flash.display.IBitmapDrawable",1,function($$private){var is=joo.is,as=joo.as;return[ 
   ...
   *
   */
  "public function BitmapData",function BitmapData$(width/*:int*/, height/*:int*/, transparent/*:Boolean = true*/, fillColor/*:uint = 0xFFFFFFFF*/) {this.elementChangeListeners$1=this.elementChangeListeners$1();if(arguments.length<4){if(arguments.length<3){transparent = true;}fillColor = 0xFFFFFFFF;}
   ...
   *
   */
  "public function getVector",function getVector(rect/*:Rectangle*/)/*:Vector$object.<uint>*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function histogram",function histogram(hRect/*:Rectangle = null*/)/*:Vector$object.<Vector$object.<Number> >*/ {if(arguments.length<1){hRect = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setVector",function setVector(rect/*:Rectangle*/, inputVector/*:Vector$object.<uint>*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
