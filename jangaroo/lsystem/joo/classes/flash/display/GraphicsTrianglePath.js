...
"public final class GraphicsTrianglePath implements flash.display.IGraphicsPath, flash.display.IGraphicsData",1,function($$private){;return[ 
   ...
   *
   */
  "public function get culling",function culling$get()/*:String*/ {
   ...
   * @private
   */
  "public function set culling",function culling$set(value/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public var",{ indices/*:Vector$object.<int>*/:null},
  /**
   ...
   */
  "public var",{ uvtData/*:Vector$object.<Number>*/:null},
  /**
   * A Vector of Numbers where each pair of numbers is treated as a point (an x, y pair).
   */
  "public var",{ vertices/*:Vector$object.<Number>*/:null},
   ...
   *
   */
  "public function GraphicsTrianglePath",function GraphicsTrianglePath$(vertices/*:Vector$object.<Number> = null*/, indices/*:Vector$object.<int> = null*/, uvtData/*:Vector$object.<Number> = null*/, culling/*:String = "none"*/) {if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){vertices = null;}indices = null;}uvtData = null;}culling = "none";}
    throw new Error('not implemented'); // TODO: implement!
  },
