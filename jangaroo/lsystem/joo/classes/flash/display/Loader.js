...
"public class Loader extends flash.display.DisplayObjectContainer",5,function($$private){;return[ 
   ...
   *
   */
  "public function Loader",function Loader$() {flash.display.DisplayObjectContainer.call(this);
   ...
   *
   */
  "public function unloadAndStop",function unloadAndStop(gc/*:Boolean = true*/)/*:void*/ {if(arguments.length<1){gc = true;}
    throw new Error('not implemented'); // TODO: implement!
  },
