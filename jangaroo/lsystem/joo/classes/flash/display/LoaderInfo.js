...
"public class LoaderInfo extends flash.events.EventDispatcher",2,function($$private){;return[function(){joo.classLoader.init(flash.events.Event);}, 
   ...
   * </listing></div>
   */
  "public function get uncaughtErrorEvents",function uncaughtErrorEvents$get()/*:UncaughtErrorEvents*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function LoaderInfo",function LoaderInfo$(loader/*:Loader = null*/) {flash.events.EventDispatcher.call(this);if(arguments.length<1){loader = null;}
    this['loader'] = loader;
    this.setUrl(window.location.href); // TODO: does this make sense?
    var params/*:Object*/ = {};
  ...
  "internal function load",function load()/*:void*/ {var this$=this;
    ...
    img.addEventListener("load", function flash$display$LoaderInfo$440_34()/*:void*/ {
