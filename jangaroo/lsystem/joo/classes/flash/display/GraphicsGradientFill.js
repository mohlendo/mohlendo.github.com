...
"public final class GraphicsGradientFill implements flash.display.IGraphicsFill, flash.display.IGraphicsData",1,function($$private){;return[ 
   ...
   */
  "public var",{ focalPointRatio/*:Number*/:NaN},
   ...
   *
   */
  "public function get interpolationMethod",function interpolationMethod$get()/*:String*/ {
   ...
   * @private
   */
  "public function set interpolationMethod",function interpolationMethod$set(value/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function get spreadMethod",function spreadMethod$get()/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set spreadMethod",function spreadMethod$set(value/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function GraphicsGradientFill",function GraphicsGradientFill$(type/*:String = "linear"*/, colors/*:Array = null*/, alphas/*:Array = null*/, ratios/*:Array = null*/, matrix/*:* = null*/, spreadMethod/*:* = "pad"*/, interpolationMethod/*:String = "rgb"*/, focalPointRatio/*:Number = 0.0*/) {if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){type = "linear";}colors = null;}alphas = null;}ratios = null;}matrix = null;}spreadMethod = "pad";}interpolationMethod = "rgb";}focalPointRatio = 0.0;}
    throw new Error('not implemented'); // TODO: implement!
  },
