...
"public class StageVideoEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function get colorSpace",function colorSpace$get()/*:String*/ {
   ...
   *
   */
  "public function StageVideoEvent",function StageVideoEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, status/*:String = null*/, colorSpace/*:String = null*/) {flash.events.Event.call(this);if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){bubbles = false;}cancelable = false;}status = null;}colorSpace = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
