...
"public class GestureEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function get phase",function phase$get()/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set phase",function phase$set(value/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function GestureEvent",function GestureEvent$(type/*:String*/, bubbles/*:Boolean = true*/, cancelable/*:Boolean = false*/, phase/*:String = null*/, localX/*:Number = 0*/, localY/*:Number = 0*/, ctrlKey/*:Boolean = false*/, altKey/*:Boolean = false*/, shiftKey/*:Boolean = false*/, commandKey/*:Boolean = false*/, controlKey/*:Boolean = false*/) {flash.events.Event.call(this);if(arguments.length<11){if(arguments.length<10){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){bubbles = true;}cancelable = false;}phase = null;}localX = 0;}localY = 0;}ctrlKey = false;}altKey = false;}shiftKey = false;}commandKey = false;}controlKey = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
