...
"public class TransformGestureEvent extends flash.events.GestureEvent",3,function($$private){;return[ 
   ...
   */
  "public function get offsetX",function offsetX$get()/*:Number*/ {
   ...
   * @private
   */
  "public function set offsetX",function offsetX$set(value/*:Number*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public function get offsetY",function offsetY$get()/*:Number*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set offsetY",function offsetY$set(value/*:Number*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function TransformGestureEvent",function TransformGestureEvent$(type/*:String*/, bubbles/*:Boolean = true*/, cancelable/*:Boolean = false*/, phase/*:String = null*/, localX/*:Number = 0*/, localY/*:Number = 0*/, scaleX/*:Number = 1.0*/, scaleY/*:Number = 1.0*/, rotation/*:Number = 0*/, offsetX/*:Number = 0*/, offsetY/*:Number = 0*/, ctrlKey/*:Boolean = false*/, altKey/*:Boolean = false*/, shiftKey/*:Boolean = false*/, commandKey/*:Boolean = false*/, controlKey/*:Boolean = false*/) {flash.events.GestureEvent.call(this);if(arguments.length<16){if(arguments.length<15){if(arguments.length<14){if(arguments.length<13){if(arguments.length<12){if(arguments.length<11){if(arguments.length<10){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){bubbles = true;}cancelable = false;}phase = null;}localX = 0;}localY = 0;}scaleX = 1.0;}scaleY = 1.0;}rotation = 0;}offsetX = 0;}offsetY = 0;}ctrlKey = false;}altKey = false;}shiftKey = false;}commandKey = false;}controlKey = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
