...
"public class SoftKeyboardEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function get triggerType",function triggerType$get()/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function SoftKeyboardEvent",function SoftKeyboardEvent$(type/*:String*/, bubbles/*:Boolean*/, cancelable/*:Boolean*/, relatedObjectVal/*:InteractiveObject*/, triggerTypeVal/*:String*/) {flash.events.Event.call(this);
    throw new Error('not implemented'); // TODO: implement!
  },
