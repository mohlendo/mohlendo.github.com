...
"public class StageVideoAvailabilityEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   */
  "public function get availability",function availability$get()/*:String*/ {
   ...
   *
   */
  "public function StageVideoAvailabilityEvent",function StageVideoAvailabilityEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, availability/*:String = null*/) {flash.events.Event.call(this);if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){bubbles = false;}cancelable = false;}availability = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
