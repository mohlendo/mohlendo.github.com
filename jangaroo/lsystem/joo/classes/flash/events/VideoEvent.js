...
"public class VideoEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function VideoEvent",function VideoEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, status/*:String = null*/) {flash.events.Event.call(this);if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){bubbles = false;}cancelable = false;}status = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
