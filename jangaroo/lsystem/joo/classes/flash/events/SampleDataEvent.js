...
"public class SampleDataEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   */
  "public function get data",function data$get()/*:ByteArray*/ {
   ...
   * @private
   */
  "public function set data",function data$set(value/*:ByteArray*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function SampleDataEvent",function SampleDataEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, theposition/*:Number = 0*/, thedata/*:ByteArray = null*/) {flash.events.Event.call(this);if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){bubbles = false;}cancelable = false;}theposition = 0;}thedata = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
