...
"public final class ContextMenuItem extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   *
   */
  "public function ContextMenuItem",function ContextMenuItem$(caption/*:String*/, separatorBefore/*:Boolean = false*/, enabled/*:Boolean = true*/, visible/*:Boolean = true*/) {flash.events.EventDispatcher.call(this);if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){separatorBefore = false;}enabled = true;}visible = true;}
