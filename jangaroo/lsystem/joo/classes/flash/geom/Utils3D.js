...
"public class Utils3D",1,function($$private){;return[ 
   ...
   *
   */
  "public static function pointTowards",function pointTowards(percent/*:Number*/, mat/*:Matrix3D*/, pos/*:Vector3D*/, at/*:Vector3D = null*/, up/*:Vector3D = null*/)/*:Matrix3D*/ {if(arguments.length<5){if(arguments.length<4){at = null;}up = null;}
   ...
   *
   */
  "public static function projectVector",function projectVector(m/*:Matrix3D*/, v/*:Vector3D*/)/*:Vector3D*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public static function projectVectors",function projectVectors(m/*:Matrix3D*/, verts/*:Vector$object.<Number>*/, projectedVerts/*:Vector$object.<Number>*/, uvts/*:Vector$object.<Number>*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
