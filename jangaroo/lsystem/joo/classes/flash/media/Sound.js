...
"public class Sound extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   *
   */
  "public function get isURLInaccessible",function isURLInaccessible$get()/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function Sound",function Sound$(stream/*:URLRequest = null*/, context/*:SoundLoaderContext = null*/) {flash.events.EventDispatcher.call(this);if(arguments.length<2){if(arguments.length<1){stream = null;}context = null;}
    if (!this.audio) { // may have been set by subclass
      this.audio = new js.Audio();
      this.audio.addEventListener('error', function flash$media$Sound$312_39(e/*:**/)/*:void*/ {
   ...
   * </listing>
   */
  "public function extract",function extract(target/*:ByteArray*/, length/*:Number*/, startPosition/*:Number = -1*/)/*:Number*/ {if(arguments.length<3){startPosition = -1;}
    throw new Error('not implemented'); // TODO: implement!
  },
