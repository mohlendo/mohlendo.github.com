...
"public class Video extends flash.display.DisplayObject",3,function($$private){;return[ 
   ...
   * </listing>
   */
  "public function Video",function Video$(width/*:int = 320*/, height/*:int = 240*/) {flash.display.DisplayObject.call(this);if(arguments.length<2){if(arguments.length<1){width = 320;}height = 240;}
    throw new Error('not implemented'); // TODO: implement!
  },
