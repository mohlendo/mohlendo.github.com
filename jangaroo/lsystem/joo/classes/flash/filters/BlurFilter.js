...
"public final class BlurFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   *
   */
  "public function BlurFilter",function BlurFilter$(blurX/*:Number = 4.0*/, blurY/*:Number = 4.0*/, quality/*:int = 1*/) {flash.filters.BitmapFilter.call(this);if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){blurX = 4.0;}blurY = 4.0;}quality = 1;}
    throw new Error('not implemented'); // TODO: implement!
  },
