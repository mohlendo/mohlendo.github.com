...
"public class ShaderFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   */
  "public function get bottomExtension",function bottomExtension$get()/*:int*/ {
   ...
   * @private
   */
  "public function set bottomExtension",function bottomExtension$set(value/*:int*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * <p>The default value is <code>0.</code></p>
   */
  "public function get leftExtension",function leftExtension$get()/*:int*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set leftExtension",function leftExtension$set(value/*:int*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * <p>The default value is <code>0.</code></p>
   */
  "public function get rightExtension",function rightExtension$get()/*:int*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set rightExtension",function rightExtension$set(value/*:int*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public function get shader",function shader$get()/*:Shader*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set shader",function shader$set(value/*:Shader*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * <p>The default value is <code>0.</code></p>
   */
  "public function get topExtension",function topExtension$get()/*:int*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set topExtension",function topExtension$set(value/*:int*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function ShaderFilter",function ShaderFilter$(shader/*:Shader = null*/) {flash.filters.BitmapFilter.call(this);if(arguments.length<1){shader = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
