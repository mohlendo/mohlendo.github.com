...
"public final class GlowFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   *
   */
  "public function GlowFilter",function GlowFilter$(color/*:uint = 0xFF0000*/, alpha/*:Number = 1.0*/, blurX/*:Number = 6.0*/, blurY/*:Number = 6.0*/, strength/*:Number = 2*/, quality/*:int = 1*/, inner/*:Boolean = false*/, knockout/*:Boolean = false*/) {flash.filters.BitmapFilter.call(this);if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){color = 0xFF0000;}alpha = 1.0;}blurX = 6.0;}blurY = 6.0;}strength = 2;}quality = 1;}inner = false;}knockout = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
