...
"public final class BevelFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   *
   */
  "public function BevelFilter",function BevelFilter$(distance/*:Number = 4.0*/, angle/*:Number = 45*/, highlightColor/*:uint = 0xFFFFFF*/, highlightAlpha/*:Number = 1.0*/, shadowColor/*:uint = 0x000000*/, shadowAlpha/*:Number = 1.0*/, blurX/*:Number = 4.0*/, blurY/*:Number = 4.0*/, strength/*:Number = 1*/, quality/*:int = 1*/, type/*:String = "inner"*/, knockout/*:Boolean = false*/) {flash.filters.BitmapFilter.call(this);if(arguments.length<12){if(arguments.length<11){if(arguments.length<10){if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){distance = 4.0;}angle = 45;}highlightColor = 0xFFFFFF;}highlightAlpha = 1.0;}shadowColor = 0x000000;}shadowAlpha = 1.0;}blurX = 4.0;}blurY = 4.0;}strength = 1;}quality = 1;}type = "inner";}knockout = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
