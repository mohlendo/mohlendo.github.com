...
"public class ConvolutionFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   *
   */
  "public function ConvolutionFilter",function ConvolutionFilter$(matrixX/*:Number = 0*/, matrixY/*:Number = 0*/, matrix/*:Array = null*/, divisor/*:Number = 1.0*/, bias/*:Number = 0.0*/, preserveAlpha/*:Boolean = true*/, clamp/*:Boolean = true*/, color/*:uint = 0*/, alpha/*:Number = 0.0*/) {flash.filters.BitmapFilter.call(this);if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){matrixX = 0;}matrixY = 0;}matrix = null;}divisor = 1.0;}bias = 0.0;}preserveAlpha = true;}clamp = true;}color = 0;}alpha = 0.0;}
    throw new Error('not implemented'); // TODO: implement!
  },
