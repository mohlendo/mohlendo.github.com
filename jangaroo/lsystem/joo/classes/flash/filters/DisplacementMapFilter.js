...
"public final class DisplacementMapFilter extends flash.filters.BitmapFilter",2,function($$private){;return[ 
   ...
   *
   */
  "public function DisplacementMapFilter",function DisplacementMapFilter$(mapBitmap/*:BitmapData = null*/, mapPoint/*:Point = null*/, componentX/*:uint = 0*/, componentY/*:uint = 0*/, scaleX/*:Number = 0.0*/, scaleY/*:Number = 0.0*/, mode/*:String = "wrap"*/, color/*:uint = 0*/, alpha/*:Number = 0.0*/) {flash.filters.BitmapFilter.call(this);if(arguments.length<9){if(arguments.length<8){if(arguments.length<7){if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){mapBitmap = null;}mapPoint = null;}componentX = 0;}componentY = 0;}scaleX = 0.0;}scaleY = 0.0;}mode = "wrap";}color = 0;}alpha = 0.0;}
    throw new Error('not implemented'); // TODO: implement!
  },
