...
"public final class GraphicElement extends flash.text.engine.ContentElement",2,function($$private){;return[ 
   ...
   */
  "public function get elementHeight",function elementHeight$get()/*:Number*/ {
   ...
   * @private
   */
  "public function set elementHeight",function elementHeight$set(value/*:Number*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * <p>The default value is 15.0.</p>
   */
  "public function get elementWidth",function elementWidth$get()/*:Number*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set elementWidth",function elementWidth$set(value/*:Number*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public function get graphic",function graphic$get()/*:DisplayObject*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set graphic",function graphic$set(value/*:DisplayObject*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function GraphicElement",function GraphicElement$(graphic/*:DisplayObject = null*/, elementWidth/*:Number = 15.0*/, elementHeight/*:Number = 15.0*/, elementFormat/*:ElementFormat = null*/, eventMirror/*:EventDispatcher = null*/, textRotation/*:String = "rotate0"*/) {flash.text.engine.ContentElement.call(this);if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){graphic = null;}elementWidth = 15.0;}elementHeight = 15.0;}elementFormat = null;}eventMirror = null;}textRotation = "rotate0";}
    throw new Error('not implemented'); // TODO: implement!
  },
