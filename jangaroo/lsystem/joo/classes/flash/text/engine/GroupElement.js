...
"public final class GroupElement extends flash.text.engine.ContentElement",2,function($$private){;return[ 
   ...
   */
  "public function get elementCount",function elementCount$get()/*:int*/ {
   ...
   *
   */
  "public function GroupElement",function GroupElement$(elements/*:Vector$object.<ContentElement> = null*/, elementFormat/*:ElementFormat = null*/, eventMirror/*:EventDispatcher = null*/, textRotation/*:String = "rotate0"*/) {flash.text.engine.ContentElement.call(this);if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){elements = null;}elementFormat = null;}eventMirror = null;}textRotation = "rotate0";}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function getElementAt",function getElementAt(index/*:int*/)/*:ContentElement*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function getElementAtCharIndex",function getElementAtCharIndex(charIndex/*:int*/)/*:ContentElement*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function getElementIndex",function getElementIndex(element/*:ContentElement*/)/*:int*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function groupElements",function groupElements(beginIndex/*:int*/, endIndex/*:int*/)/*:GroupElement*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function mergeTextElements",function mergeTextElements(beginIndex/*:int*/, endIndex/*:int*/)/*:TextElement*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function replaceElements",function replaceElements(beginIndex/*:int*/, endIndex/*:int*/, newElements/*:Vector$object.<ContentElement>*/)/*:Vector$object.<ContentElement>*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setElements",function setElements(value/*:Vector$object.<ContentElement>*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function splitTextElement",function splitTextElement(elementIndex/*:int*/, splitIndex/*:int*/)/*:TextElement*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function ungroupElements",function ungroupElements(groupIndex/*:int*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
