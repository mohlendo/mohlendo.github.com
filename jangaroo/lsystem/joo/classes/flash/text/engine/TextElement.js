...
"public final class TextElement extends flash.text.engine.ContentElement",2,function($$private){;return[ 
   ...
   * </listing>
   */
  "public function TextElement",function TextElement$(text/*:String = null*/, elementFormat/*:ElementFormat = null*/, eventMirror/*:EventDispatcher = null*/, textRotation/*:String = "rotate0"*/) {flash.text.engine.ContentElement.call(this);if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){text = null;}elementFormat = null;}eventMirror = null;}textRotation = "rotate0";}
    throw new Error('not implemented'); // TODO: implement!
  },
