...
"public final class FontMetrics",1,function($$private){;return[ 
   ...
   */
  "public var",{ emBox/*:Rectangle*/:null},
  /**
   ...
   *
   */
  "public var",{ strikethroughOffset/*:Number*/:NaN},
  /**
   * The strikethroughThickness value is the suggested thickness for a strikethrough.
   */
  "public var",{ strikethroughThickness/*:Number*/:NaN},
  /**
   ...
   *
   */
  "public var",{ subscriptOffset/*:Number*/:NaN},
  /**
   ...
   */
  "public var",{ subscriptScale/*:Number*/:NaN},
  /**
   ...
   *
   */
  "public var",{ superscriptOffset/*:Number*/:NaN},
  /**
   ...
   */
  "public var",{ superscriptScale/*:Number*/:NaN},
  /**
   ...
   *
   */
  "public var",{ underlineOffset/*:Number*/:NaN},
  /**
   * The underlineThickness value is the suggested thickness for an underline.
   */
  "public var",{ underlineThickness/*:Number*/:NaN},
   ...
   *
   */
  "public function FontMetrics",function FontMetrics$(emBox/*:Rectangle*/, strikethroughOffset/*:Number*/, strikethroughThickness/*:Number*/, underlineOffset/*:Number*/, underlineThickness/*:Number*/, subscriptOffset/*:Number*/, subscriptScale/*:Number*/, superscriptOffset/*:Number*/, superscriptScale/*:Number*/) {
