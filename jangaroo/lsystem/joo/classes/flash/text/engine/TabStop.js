...
"public final class TabStop",1,function($$private){;return[ 
   ...
   * @private
   */
  "public function set alignment",function alignment$set(value/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function get decimalAlignmentToken",function decimalAlignmentToken$get()/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set decimalAlignmentToken",function decimalAlignmentToken$set(value/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set position",function position$set(value/*:Number*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function TabStop",function TabStop$(alignment/*:String = "start"*/, position/*:Number = 0.0*/, decimalAlignmentToken/*:String = ""*/) {if(arguments.length<3){if(arguments.length<2){if(arguments.length<1){alignment = "start";}position = 0.0;}decimalAlignmentToken = "";}
    throw new Error('not implemented'); // TODO: implement!
  },
];},[],["Error"], "0.8.0", "0.9.6"
);