...
"public class SharedObject extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   *
   */
  "public function send",function send(/*...rest*/)/*:void*/ {var rest=Array.prototype.slice.call(arguments);
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function SharedObject",function SharedObject$(data/*:Object*/) {flash.events.EventDispatcher.call(this);
    this._data$2 = data;
  },
