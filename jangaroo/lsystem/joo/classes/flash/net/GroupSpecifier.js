...
"public class GroupSpecifier",1,function($$private){;return[ 
   ...
   *
   */
  "public function get ipMulticastMemberUpdatesEnabled",function ipMulticastMemberUpdatesEnabled$get()/*:Boolean*/ {
   ...
   * @private
   */
  "public function set ipMulticastMemberUpdatesEnabled",function ipMulticastMemberUpdatesEnabled$set(value/*:Boolean*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function get multicastEnabled",function multicastEnabled$get()/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set multicastEnabled",function multicastEnabled$set(value/*:Boolean*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function get objectReplicationEnabled",function objectReplicationEnabled$get()/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set objectReplicationEnabled",function objectReplicationEnabled$set(value/*:Boolean*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public function get peerToPeerDisabled",function peerToPeerDisabled$get()/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set peerToPeerDisabled",function peerToPeerDisabled$set(value/*:Boolean*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function get postingEnabled",function postingEnabled$get()/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set postingEnabled",function postingEnabled$set(value/*:Boolean*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function get routingEnabled",function routingEnabled$get()/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set routingEnabled",function routingEnabled$set(value/*:Boolean*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public function get serverChannelEnabled",function serverChannelEnabled$get()/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set serverChannelEnabled",function serverChannelEnabled$set(value/*:Boolean*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function GroupSpecifier",function GroupSpecifier$(name/*:String*/) {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function addBootstrapPeer",function addBootstrapPeer(peerID/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function addIPMulticastAddress",function addIPMulticastAddress(address/*:String*/, port/*:* = null*/, source/*:String = null*/)/*:void*/ {if(arguments.length<3){if(arguments.length<2){port = null;}source = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function authorizations",function authorizations()/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public static function encodeBootstrapPeerIDSpec",function encodeBootstrapPeerIDSpec(peerID/*:String*/)/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public static function encodeIPMulticastAddressSpec",function encodeIPMulticastAddressSpec(address/*:String*/, port/*:* = null*/, source/*:String = null*/)/*:String*/ {if(arguments.length<3){if(arguments.length<2){port = null;}source = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public static function encodePostingAuthorization",function encodePostingAuthorization(password/*:String*/)/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public static function encodePublishAuthorization",function encodePublishAuthorization(password/*:String*/)/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function groupspecWithAuthorizations",function groupspecWithAuthorizations()/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function groupspecWithoutAuthorizations",function groupspecWithoutAuthorizations()/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "public function makeUnique",function makeUnique()/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setPostingPassword",function setPostingPassword(password/*:String = null*/, salt/*:String = null*/)/*:void*/ {if(arguments.length<2){if(arguments.length<1){password = null;}salt = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function setPublishPassword",function setPublishPassword(password/*:String = null*/, salt/*:String = null*/)/*:void*/ {if(arguments.length<2){if(arguments.length<1){password = null;}salt = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
