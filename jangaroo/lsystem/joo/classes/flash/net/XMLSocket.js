...
"public class XMLSocket extends flash.events.EventDispatcher",2,function($$private){;return[ 
   ...
   */
  "public function get timeout",function timeout$get()/*:int*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set timeout",function timeout$set(value/*:int*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function XMLSocket",function XMLSocket$(host/*:String = null*/, port/*:int = 0*/) {flash.events.EventDispatcher.call(this);if(arguments.length<2){if(arguments.length<1){host = null;}port = 0;}
    throw new Error('not implemented'); // TODO: implement!
  },
