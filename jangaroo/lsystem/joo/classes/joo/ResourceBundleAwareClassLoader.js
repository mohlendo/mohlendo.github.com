...
"public class ResourceBundleAwareClassLoader extends joo.DynamicClassLoader",4,function($$private){;return[function(){joo.classLoader.init(joo.localization,joo.NativeClassDeclaration);}, 
  ...
  "override protected function createClassDeclaration",function createClassDeclaration(packageDef/*:String*/, metadata/*:Object*/, classDef/*:String*/, inheritanceLevel/*:int*/, memberFactory/*:Function*/, publicStaticMethodNames/*:Array*/, dependencies/*:Array*/)/*:JooClassDeclaration*/ {
    var cd/* : JooClassDeclaration*/ =/* joo.JooClassDeclaration*/(this.createClassDeclaration$4(packageDef, metadata, classDef, inheritanceLevel, memberFactory, publicStaticMethodNames, dependencies));
