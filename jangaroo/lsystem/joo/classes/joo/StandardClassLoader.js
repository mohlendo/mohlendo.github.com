...
"public class StandardClassLoader extends joo.SystemClassLoader",2,function($$private){;return[ 
  ...
  "public function StandardClassLoader",function StandardClassLoader$() {joo.SystemClassLoader.call(this);
    this.imports$2 = [];
  },

  "override protected function createClassDeclaration",function createClassDeclaration(packageDef/*:String*/, metadata/*:Object*/, classDef/*:String*/, inheritanceLevel/*:int*/, memberFactory/*:Function*/, publicStaticMethodNames/*:Array*/, dependencies/*:Array*/)/*:JooClassDeclaration*/ {
  ...
  "public function run",function run(mainClassName/* : String, ...args*/)/* : void*/ {var this$=this;var args=Array.prototype.slice.call(arguments,1);
    this.complete(function joo$StandardClassLoader$54_19()/* : void*/ {
   ...
   */
  "public override function init",function init(/*... classes*/)/* : Function*/ {var classes=Array.prototype.slice.call(arguments);
    var clazz/* : Function*/;
    for (var i/*:int*/ =0; i<classes.length; ++i) {
      clazz = classes[i];
      if ("$class" in clazz) {
        clazz =/* joo.NativeClassDeclaration*/(clazz["$class"]).init().constructor_;
      }
    }
    return clazz;
  },
  ...
  "protected function initNativeClasses",function initNativeClasses()/* : void*/ {
