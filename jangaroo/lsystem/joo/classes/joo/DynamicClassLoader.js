...
"public class DynamicClassLoader extends joo.StandardClassLoader",3,function($$private){var trace=joo.trace;return[ 
  ...
  "public function DynamicClassLoader",function DynamicClassLoader$() {joo.StandardClassLoader.call(this);this.resourceByPath$3=this.resourceByPath$3();this.onCompleteCallbacks$3=this.onCompleteCallbacks$3();this.pendingDependencies$3=this.pendingDependencies$3();this.pendingClassState$3=this.pendingClassState$3();
  ...
  "override public function prepare",function prepare(/*...params*/)/*:JooClassDeclaration*/ {var params=Array.prototype.slice.call(arguments);
...
//          }
  ...
  "private function loadResource",function loadResource(path/*:String*/)/*:void*/ {var this$=this;
