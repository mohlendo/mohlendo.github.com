...
"public class TextConverter",1,function($$private){;return[ 
   ...
   *
   */
  "public static function export",function export(source/*:TextFlow*/, format/*:String*/, conversionType/*:String*/)/*:Object*/ {
   ...
   * </listing>
   */
  "public static function getExporter",function getExporter(format/*:String*/)/*:ITextExporter*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public static function getImporter",function getImporter(format/*:String*/, config/*:IConfiguration = null*/)/*:ITextImporter*/ {if(arguments.length<2){config = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public static function importToFlow",function importToFlow(source/*:Object*/, format/*:String*/, config/*:IConfiguration = null*/)/*:TextFlow*/ {if(arguments.length<3){config = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
