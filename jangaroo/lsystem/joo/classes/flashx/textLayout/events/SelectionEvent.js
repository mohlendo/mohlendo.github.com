...
"public class SelectionEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function get selectionState",function selectionState$get()/*:SelectionState*/ {
   ...
   * @private
   */
  "public function set selectionState",function selectionState$set(value/*:SelectionState*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function SelectionEvent",function SelectionEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, selectionState/*:SelectionState = null*/) {flash.events.Event.call(this);if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){bubbles = false;}cancelable = false;}selectionState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
