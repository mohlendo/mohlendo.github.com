...
"public class StatusChangeEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function get element",function element$get()/*:FlowElement*/ {
   ...
   * @private
   */
  "public function set element",function element$set(value/*:FlowElement*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function get errorEvent",function errorEvent$get()/*:ErrorEvent*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set errorEvent",function errorEvent$set(value/*:ErrorEvent*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function get status",function status$get()/*:String*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * @private
   */
  "public function set status",function status$set(value/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function StatusChangeEvent",function StatusChangeEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/, element/*:FlowElement = null*/, status/*:String = null*/, errorEvent/*:ErrorEvent = null*/) {flash.events.Event.call(this);if(arguments.length<6){if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){bubbles = false;}cancelable = false;}element = null;}status = null;}errorEvent = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
