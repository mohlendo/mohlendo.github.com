...
"public class TextLayoutEvent extends flash.events.Event",2,function($$private){;return[ 
   ...
   *
   */
  "public function TextLayoutEvent",function TextLayoutEvent$(type/*:String*/, bubbles/*:Boolean = false*/, cancelable/*:Boolean = false*/) {flash.events.Event.call(this);if(arguments.length<3){if(arguments.length<2){bubbles = false;}cancelable = false;}
