...
"public final class TextFlowTextLineFactory extends flashx.textLayout.factory.TextLineFactoryBase",2,function($$private){;return[ 
   ...
   */
  "public function TextFlowTextLineFactory",function TextFlowTextLineFactory$() {flashx.textLayout.factory.TextLineFactoryBase.call(this);
   ...
   *
   */
  "public function createTextLines",function createTextLines(callback/*:Function*/, textFlow/*:TextFlow*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
