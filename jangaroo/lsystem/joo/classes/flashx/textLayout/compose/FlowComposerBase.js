...
"public class FlowComposerBase",1,function($$private){;return[ 
   ...
   * Constructor.
   */
  "public function FlowComposerBase",function FlowComposerBase$() {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function damage",function damage(startPosition/*:int*/, damageLength/*:int*/, damageType/*:String*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function findLineAtPosition",function findLineAtPosition(absolutePosition/*:int*/, preferPrevious/*:Boolean = false*/)/*:TextFlowLine*/ {if(arguments.length<2){preferPrevious = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function findLineIndexAtPosition",function findLineIndexAtPosition(absolutePosition/*:int*/, preferPrevious/*:Boolean = false*/)/*:int*/ {if(arguments.length<2){preferPrevious = false;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function getLineAt",function getLineAt(index/*:int*/)/*:TextFlowLine*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function isDamaged",function isDamaged(absolutePosition/*:int*/)/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function updateLengths",function updateLengths(startPosition/*:int*/, deltaLength/*:int*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
];},[],["Error"], "0.8.0", "0.9.6"
);