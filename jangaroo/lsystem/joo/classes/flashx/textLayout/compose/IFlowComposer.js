...
"public interface IFlowComposer",1,function($$private){;return[ /*
   ...
   *
   * /
  function rootElement():ContainerFormattedElement*/,/*
   ...
   *
   * /
  function swfContext():ISWFContext*/,/*

  /**
   * @private
   * /
  function swfContext(value:ISWFContext):void*/,/*
