...
"public final class CharacterUtil",1,function($$private){;return[ 
   ...
   *
   */
  "public static function isHighSurrogate",function isHighSurrogate(charCode/*:int*/)/*:Boolean*/ {
   ...
   *
   */
  "public static function isLowSurrogate",function isLowSurrogate(charCode/*:int*/)/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public static function isWhitespace",function isWhitespace(charCode/*:int*/)/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
