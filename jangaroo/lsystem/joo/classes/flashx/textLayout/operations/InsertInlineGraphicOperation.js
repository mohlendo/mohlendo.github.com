...
"public class InsertInlineGraphicOperation extends flashx.textLayout.operations.FlowTextOperation",3,function($$private){;return[ 
   ...
   *
   */
  "public function InsertInlineGraphicOperation",function InsertInlineGraphicOperation$(operationState/*:SelectionState*/, source/*:Object*/, width/*:Object*/, height/*:Object*/, options/*:Object = null*/) {flashx.textLayout.operations.FlowTextOperation.call(this);if(arguments.length<5){options = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
