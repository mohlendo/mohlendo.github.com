...
"public class ClearFormatOperation extends flashx.textLayout.operations.FlowTextOperation",3,function($$private){;return[ 
   ...
   *
   */
  "public function ClearFormatOperation",function ClearFormatOperation$(operationState/*:SelectionState*/, leafFormat/*:ITextLayoutFormat*/, paragraphFormat/*:ITextLayoutFormat*/, containerFormat/*:ITextLayoutFormat = null*/) {flashx.textLayout.operations.FlowTextOperation.call(this);if(arguments.length<4){containerFormat = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
