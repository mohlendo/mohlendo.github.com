...
"public class ClearFormatOnElementOperation extends flashx.textLayout.operations.FlowElementOperation",4,function($$private){;return[ 
   ...
   *
   */
  "public function ClearFormatOnElementOperation",function ClearFormatOnElementOperation$(operationState/*:SelectionState*/, targetElement/*:FlowElement*/, format/*:ITextLayoutFormat*/, relativeStart/*:int = 0*/, relativeEnd/*:int = -1*/) {flashx.textLayout.operations.FlowElementOperation.call(this);if(arguments.length<5){if(arguments.length<4){relativeStart = 0;}relativeEnd = -1;}
    throw new Error('not implemented'); // TODO: implement!
  },
