...
"public class SelectionState extends flashx.textLayout.elements.TextRange",2,function($$private){;return[ 
   ...
   *
   */
  "public function get pointFormat",function pointFormat$get()/*:ITextLayoutFormat*/ {
   ...
   * @private
   */
  "public function set pointFormat",function pointFormat$set(value/*:ITextLayoutFormat*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function SelectionState",function SelectionState$(root/*:TextFlow*/, anchorPosition/*:int*/, activePosition/*:int*/, format/*:ITextLayoutFormat = null*/) {flashx.textLayout.elements.TextRange.call(this);if(arguments.length<4){format = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "override public function updateRange",function updateRange(newAnchorPosition/*:int*/, newActivePosition/*:int*/)/*:Boolean*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
