...
"public class EditManager extends flashx.textLayout.edit.SelectionManager implements flashx.textLayout.edit.IEditManager",2,function($$private){;return[ 
   ...
   */
  "public function get undoManager",function undoManager$get()/*:IUndoManager*/ {
   ...
   * </listing>
   */
  "public function EditManager",function EditManager$(undoManager/*:IUndoManager = null*/) {flashx.textLayout.edit.SelectionManager.call(this);if(arguments.length<1){undoManager = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function applyContainerFormat",function applyContainerFormat(containerFormat/*:ITextLayoutFormat*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<2){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function applyFormat",function applyFormat(leafFormat/*:ITextLayoutFormat*/, paragraphFormat/*:ITextLayoutFormat*/, containerFormat/*:ITextLayoutFormat*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<4){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function applyFormatToElement",function applyFormatToElement(targetElement/*:FlowElement*/, format/*:ITextLayoutFormat*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<3){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function applyLeafFormat",function applyLeafFormat(characterFormat/*:ITextLayoutFormat*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<2){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function applyLink",function applyLink(href/*:String*/, targetString/*:String = null*/, extendToLinkBoundary/*:Boolean = false*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<4){if(arguments.length<3){if(arguments.length<2){targetString = null;}extendToLinkBoundary = false;}operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function applyParagraphFormat",function applyParagraphFormat(paragraphFormat/*:ITextLayoutFormat*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<2){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function applyTCY",function applyTCY(tcyOn/*:Boolean*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<2){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function beginCompositeOperation",function beginCompositeOperation()/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function changeElementID",function changeElementID(newID/*:String*/, targetElement/*:FlowElement*/, relativeStart/*:int = 0*/, relativeEnd/*:int = -1*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){relativeStart = 0;}relativeEnd = -1;}operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function changeStyleName",function changeStyleName(newName/*:String*/, targetElement/*:FlowElement*/, relativeStart/*:int = 0*/, relativeEnd/*:int = -1*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<5){if(arguments.length<4){if(arguments.length<3){relativeStart = 0;}relativeEnd = -1;}operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function clearFormat",function clearFormat(leafFormat/*:ITextLayoutFormat*/, paragraphFormat/*:ITextLayoutFormat*/, containerFormat/*:ITextLayoutFormat*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<4){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function clearFormatOnElement",function clearFormatOnElement(targetElement/*:FlowElement*/, format/*:ITextLayoutFormat*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<3){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function cutTextScrap",function cutTextScrap(operationState/*:SelectionState = null*/)/*:TextScrap*/ {if(arguments.length<1){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function deleteNextCharacter",function deleteNextCharacter(operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<1){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function deleteNextWord",function deleteNextWord(operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<1){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function deletePreviousCharacter",function deletePreviousCharacter(operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<1){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function deletePreviousWord",function deletePreviousWord(operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<1){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function deleteText",function deleteText(operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<1){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "override public function doOperation",function doOperation(operation/*:FlowOperation*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "override public function editHandler",function editHandler(event/*:Event*/)/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function endCompositeOperation",function endCompositeOperation()/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function insertInlineGraphic",function insertInlineGraphic(source/*:Object*/, width/*:Object*/, height/*:Object*/, options/*:Object = null*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<5){if(arguments.length<4){options = null;}operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function insertText",function insertText(text/*:String*/, origOperationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<2){origOperationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function modifyInlineGraphic",function modifyInlineGraphic(source/*:Object*/, width/*:Object*/, height/*:Object*/, options/*:Object = null*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<5){if(arguments.length<4){options = null;}operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function overwriteText",function overwriteText(text/*:String*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<2){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function pasteTextScrap",function pasteTextScrap(scrapToPaste/*:TextScrap*/, operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<2){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function redo",function redo()/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function splitParagraph",function splitParagraph(operationState/*:SelectionState = null*/)/*:void*/ {if(arguments.length<1){operationState = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function undo",function undo()/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   */
  "protected function updateAllControllers",function updateAllControllers()/*:void*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
