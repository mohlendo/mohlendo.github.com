...
"public class TextScrap",1,function($$private){;return[ 
   ...
   *
   */
  "public function TextScrap",function TextScrap$(textFlow/*:TextFlow = null*/) {if(arguments.length<1){textFlow = null;}
   ...
   *
   */
  "public function clone",function clone()/*:TextScrap*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public static function createTextScrap",function createTextScrap(range/*:TextRange*/)/*:TextScrap*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
