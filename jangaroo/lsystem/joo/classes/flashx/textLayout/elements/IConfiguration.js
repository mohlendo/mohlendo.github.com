...
"public interface IConfiguration",1,function($$private){;return[ /*
   ...
   *
   * /
  function defaultLinkActiveFormat():ITextLayoutFormat*/,/*
   ...
   *
   * /
  function defaultLinkHoverFormat():ITextLayoutFormat*/,/*
   ...
   *
   * /
  function defaultLinkNormalFormat():ITextLayoutFormat*/,/*
   ...
   *
   * /
  function enableAccessibility():Boolean*/,/*
   ...
   *
   * /
  function flowComposerClass():Class*/,/*
   ...
   *
   * /
  function focusedSelectionFormat():SelectionFormat*/,/*
   ...
   *
   * /
  function inactiveSelectionFormat():SelectionFormat*/,/*
   ...
   *
   * /
  function inlineGraphicResolverFunction():Function*/,/*
   ...
   * /
  function manageEnterKey():Boolean*/,/*
   ...
   *
   * /
  function releaseLineCreationData():Boolean*/,/*
   ...
   * /
  function scrollDragDelay():Number*/,/*
   ...
   *
   * /
  function textFlowInitialFormat():ITextLayoutFormat*/,/*
   ...
   *
   * /
  function unfocusedSelectionFormat():SelectionFormat*/,
];},[],[], "0.8.0", "0.9.6"
);