...
"public class FlowLeafElement extends flashx.textLayout.elements.FlowElement",2,function($$private){;return[ 
   ...
   *
   */
  "override public function get computedFormat",function computedFormat$get()/*:ITextLayoutFormat*/ {
   ...
   */
  "public function FlowLeafElement",function FlowLeafElement$() {flashx.textLayout.elements.FlowElement.call(this);
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   *
   */
  "public function getComputedFontMetrics",function getComputedFontMetrics()/*:FontMetrics*/ {
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function getNextLeaf",function getNextLeaf(limitElement/*:FlowGroupElement = null*/)/*:FlowLeafElement*/ {if(arguments.length<1){limitElement = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
   ...
   * </listing>
   */
  "public function getPreviousLeaf",function getPreviousLeaf(limitElement/*:FlowGroupElement = null*/)/*:FlowLeafElement*/ {if(arguments.length<1){limitElement = null;}
    throw new Error('not implemented'); // TODO: implement!
  },
